    ...
    public partial class wwwww : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.milk_areas", t => t.ParentId)
                .Index(t => t.ParentId);
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Card_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.milk_areas", t => t.AreaId)
                .ForeignKey("dbo.milk_areas", t => t.CityId)
                .ForeignKey("dbo.milk_promoters", t => t.PromoterId)
                .ForeignKey("dbo.milk_areas", t => t.ProveId)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Promoter_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_SpecialCard_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.milk_customer", "ProveId", "dbo.milk_areas");
            DropForeignKey("dbo.milk_customer", "PromoterId", "dbo.milk_promoters");
            DropForeignKey("dbo.milk_customer", "CityId", "dbo.milk_areas");
            DropForeignKey("dbo.milk_customer", "AreaId", "dbo.milk_areas");
            DropForeignKey("dbo.milk_areas", "ParentId", "dbo.milk_areas");
            ...
            DropIndex("dbo.milk_customer", new[] { "AreaId" });
            DropIndex("dbo.milk_customer", new[] { "CityId" });
            DropIndex("dbo.milk_customer", new[] { "ProveId" });
            DropIndex("dbo.milk_customer", new[] { "PromoterId" });
            DropIndex("dbo.AbpBackgroundJobs", new[] { "IsAbandoned", "NextTryTime" });
            DropIndex("dbo.milk_areas", new[] { "ParentId" });
            ...
            DropTable("dbo.milk_specialcard",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_SpecialCard_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            ...
            DropTable("dbo.milk_promoters",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Promoter_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.milk_customer",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Customer_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.milk_card",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_Card_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
